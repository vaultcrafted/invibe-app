...
function CassaTurnoDetail({ destination, shiftNum, onBack }) {
  ...
  async function handleSave() {
    ...
    setSaving(true)
    setSaveError(null)
    // Etichetta condivisa fra il movimento e la sua riga sul foglio: serve a
    // sapere, dopo, se quella riga e' davvero arrivata sulla rendicontazione.
    const movId = Date.now().toString(36) + Math.random().toString(36).slice(2, 8)
    ...
    enqueueSheetOnly([{
      __kind: 'cassa', destination, shift_num: shiftNum, azione: 'add', movId,
