...
export default function VotePanel({ destination, shiftNum, members, currentUserId, isAdmin, renderList }) {
  ...
  return renderList(votableMembers, hasVoted, dailyVote, castVote, voteCounts, isAdmin)
}
